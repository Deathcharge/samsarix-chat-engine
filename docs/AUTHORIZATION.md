...
Version 0.4 supports two credential classes with deliberately different jobs:
...
| Post over HTTP or WebSocket | room listed in token plus `room:write` |

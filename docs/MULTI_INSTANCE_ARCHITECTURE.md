...
- archive and ban actions close matching sockets on every process (signed-member two-process acceptance now proves codes 4409/4403, retained history after reopen, unban/reconnect, freeze/mute enforcement, and isolation of unrelated rooms; overlapping admission/renewal/outage races remain separate checks);

...
1. initializes current schema 10 through the real Samsarix application;
...
1. enables continuous WAL archiving, provisions a separate application role, and initializes current schema 10 through Samsarix;

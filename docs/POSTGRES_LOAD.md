...
Initial live results are pending; local unit tests and a JSON schema alone are not performance evidence. Exact CI runs, profiles, outcomes and artifact digests will be recorded after execution. No throughput number is claimed before those runs succeed.

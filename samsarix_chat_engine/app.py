...
def create_app(settings: Settings | None = None) -> FastAPI:
    ...
    if resolved.storage_backend == "postgres":
        ...
        postgres_runtime = PostgresApplicationRuntime(
            ...
            relay_max_pending_events=resolved.postgres_relay_max_pending_events,
            relay_max_event_age_seconds=resolved.postgres_relay_max_event_age_seconds,
    ...
    async def create_message(
        ...
        try:
            message, created = await store.create_message(
                ...
                mentioned_subjects=payload.mentioned_subjects,
            ...
            while True:
                ...
                try:
                    message, created = await store.create_message(
                        ...
                        mentioned_subjects=command.mentioned_subjects,
